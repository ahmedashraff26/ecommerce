...
export default function Product({ product }) {
    ...
    return (
        // <div className="relative mx-10 my-5 w-full max-w-xs overflow-hidden rounded-lg bg-white shadow-md border border-black">
        //     <a href="#" onClick={getProductDetails}>
        //         <img className="w-full rounded-t-lg object-cover hover:scale-110 transition-transform" src={product.imageCover} alt="product image" />
        //     </a>
        ...
        //             </p>
        //             <a href="#" className="flex items-center rounded-md bg-slate-900 p-2 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
        ...
        <div className="relative flex flex-col text-gray-700 max-w-md bg-white shadow-lg bg-clip-border rounded-xl mx-auto">
            <div onClick={getProductDetails} className="relative mx-4 mt-4 overflow-hidden text-gray-700 bg-white bg-clip-border rounded-xl border-2 cursor-pointer">
                <img
